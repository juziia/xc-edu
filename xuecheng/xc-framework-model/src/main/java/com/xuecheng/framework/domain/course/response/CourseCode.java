...
public enum CourseCode implements ResultCode {
    ...
    COURSE_IS_NOTEXIST(false,31103,"课程为空"),
    COURSE_ADD_TEACHPLAN_ERROR(false,31104,"添加课程计划失败"),
    COURSE_TEACHPLAN_MEDIA_GRADERROR(false,31105,"课程计划级别错误,只能对课程计划级别为3的才能进行关联");
